<template>
    <div>
        <div class="pt-5 d-flex justify-content-around flex-sm-column flex-column flex-md-column flex-lg-row">
            ...
            <div class="col-md-10 col-lg-4 ml-md-auto mr-md-auto  col-sm-12">
